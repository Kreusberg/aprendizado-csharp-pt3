...
Album albumIra = new("albumDoIra!");

Banda ira = new("Ira!");
ira.AdicionarNota(new Avaliacao(10));
ira.AdicionarNota(new Avaliacao(8));
ira.AdicionarNota(new Avaliacao(6));
ira.AdicionarAlbum(albumIra);

Musica musicaIra = new(ira, "musicaIra");
albumIra.AdicionarMusica(musicaIra);
...
void ExibirOpcoesDoMenu()
{
    ...
    Console.WriteLine("Digite 3 para registar uma música");
